...
export function Navbar({ activeTab, setActiveTab, documentCount }: NavbarProps) {
  return (
    <header className="h-16 md:h-20 border-b border-slate-200 dark:border-[#222b3e] bg-white dark:bg-[#181f2e] flex items-center justify-between px-3 pl-14 lg:pl-6 md:px-8 z-30 relative shrink-0 gap-2 transition-colors duration-200">
      ...
      {/* Right Controls: Live System Status Badges & Theme Toggle */}
      <div className="flex items-center gap-3">
        <div className="hidden lg:flex items-center gap-3">
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl neu-pressed text-xs text-slate-700 dark:text-slate-300">
